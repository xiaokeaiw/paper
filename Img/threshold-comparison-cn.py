...
plt.tight_layout()
plt.savefig('files/Img/draft/threshold_sensitivity.pdf', dpi=300, bbox_inches='tight',
           transparent=False, facecolor='white')
plt.savefig('files/Img/draft/threshold_sensitivity.png', dpi=300, bbox_inches='tight',
           transparent=False, facecolor='white')
print('Done!')
