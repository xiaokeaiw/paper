...
\setlength{\heavyrulewidth}{1.5pt}  % 三线表顶线、底线
\setlength{\lightrulewidth}{0.75pt} % 三线表中线
\usepackage{pgfplots}
\pgfplotsset{compat=1.18}
\usetikzlibrary{matrix,shapes.geometric,arrows.meta,fit,backgrounds,positioning,calc}
